...
<div class="row m-0">
    <div class="col-lg-12 col-md-12 col-xs-12">
        ...
        <div class="form-group">
			...
			<input type="text" class="form-control" name="tendangnhap" id="tendangnhap" aria-describedby="helpId" placeholder="" />
		</div>
        <div class="form-group">
			<label for="">Mật khẩu</label>
			<input type="text" class="form-control" value='123456' name="matkhau" id="matkhau" aria-describedby="helpId" placeholder="" />
		</div>
        <div class="form-group">
