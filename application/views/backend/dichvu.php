...
<div class="row m-0">
    ...
    <table class="table table-bordered">
        ...
        <tbody class='table_danhsachtintuc'>
            ...
            $numberperpage = 10;
            $page=0;
            $total = count($this->tool_model->get_all_table_where('tintuc'," loai=1 "));
            if(!isset($_GET['page'])){
                $page = 0;
                $limit_s = 0;
            ...
            $i=1;
            foreach($this->tool_model->get_all_table_where('tintuc',"loai=1 order by sapxep desc limit $limit_s,$limit_e") as $row){
                ...
                echo "<tr>
                    ...
                    <!--<button type='button' onclick='guitintuc(".$row->id.")' class='btn btn-$class btn-sm btn-guithongbao'	id='".$row->id."'><i class='fa fa-send'></i>&nbsp;&nbsp;$mess thông báo</button>-->";
                    echo "</td>
                </tr>";
                $i++;
            }?>
