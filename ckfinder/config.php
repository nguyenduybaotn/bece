...
session_start();
/*
if( isset($_GET['ses']) && $_GET['ses'] == "login_ck" && isset($_GET['redirect']) ){
	$_SESSION['logged_ck'] = true;
	//session_destroy();
	header("location: ".$_GET['redirect']);
	exit();
}
if( isset($_GET['ses']) && $_GET['ses'] == "logout_ck" && isset($_GET['redirect']) ){
	//$_SESSION['logged_ck'] = false;
	unset($_SESSION['logged_ck']);
	header("location: ".$_GET['redirect']);
	exit();
}
if(isset($_SESSION['logged_ck'])){
    echo $_SESSION['logged_ck'];
...
$config['authentication'] = function () {
    if(isset($_SESSION['logged_ck']) && $_SESSION['logged_ck']){
        return true;
    }else{
        return false;
    }
...
$config['licenseName'] = 'quangtoanle.com';
$config['licenseKey']  = '58Y8JBAKNJC25P9FXHVHGN8LYQTJC';
